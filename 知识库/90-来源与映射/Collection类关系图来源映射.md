...
本页追踪 `Collection类关系图` 文章原文与知识页之间的固定映射。  
原始文字位于 `raw/sources/src-20260512-pdai-collection-relations/original.md`，不在知识页直接复刻。
...
| [[第二大脑-90-收件箱/03-知识/Collection类关系图|Collection类关系图（收件箱）]] | `00-收件箱/Collection 类关系图.md` | 收件箱层来源登记与草稿摘要 |
