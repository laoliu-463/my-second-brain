...
本页追踪 `SAAS 业务流程图 (code-review-graph official API)` 原文与知识页之间的固定映射。  
原始文字位于 `raw/sources/src-20260524-code-review-graph-saas-flow/original.md`，不在知识页直接复刻。
...
- 已完成状态：`00-收集箱/未命名 2.md` 仍保留原文（与 `raw/sources/.../original.md` 内容高度重复），正式提炼见 `知识库/sources/src-20260524-code-review-graph-saas-flow.md` 与综合页。
- 主来源页为 `知识库/sources/src-20260524-code-review-graph-saas-flow.md`。
- 后续规则：原文件超过 7000 行，已归档为证据层；正式 wiki 中只保留导航、结论和取证入口。
