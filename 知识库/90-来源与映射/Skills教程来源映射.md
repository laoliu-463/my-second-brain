...
本页追踪 `Skills 教程 | 菜鸟教程` 原文与知识页之间的固定映射。  
原始文字位于 `raw/sources/src-20260617-runoob-skills-tutorial/original.md`，不在知识页直接复刻。
...
- 已完成状态：`00-收件箱/Skills 教程  菜鸟教程.md` 仍保留原文，正式提炼见 `知识库/sources/src-20260617-runoob-skills-tutorial.md` 与概念页 `知识库/concepts/Agent Skills.md`。
- 主来源页为 `知识库/sources/src-20260617-runoob-skills-tutorial.md`。
- 后续规则：该来源是入门介绍，不作为本知识库的工程执行规范。实际技能使用仍以 AGENTS.md、实际技能文件和工程验证链路为准。
