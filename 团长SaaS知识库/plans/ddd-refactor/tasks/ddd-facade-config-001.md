---
kb_id: "KB-PLAN-DDD-DDD-FACADE-CONFIG-001"
title: "DDD-FACADE-CONFIG-001"
domain: "config"
category: "task_card"
source_type: "mixed"
freshness: "current"
...
新增 ConfigDomainFacade，只提供配置读取能力，收敛 1-3 个消费方，不执行业务规则。
...
配置域计划、配置域审查报告、SysConfigService.java、RuleCenterService.java、配置消费调用点。
...
- plans/ddd-refactor/tasks/ddd-facade-config-001.md
- plans/ddd-refactor/domains/config-ddd-plan.md
