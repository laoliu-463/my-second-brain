---
kb_id: "KB-PLAN-DDD-DDD-TEST-ORDER-SYNC-001"
title: "DDD-TEST-ORDER-SYNC-001"
domain: "order"
category: "task_card"
source_type: "mixed"
freshness: "current"
...
只新增或增强订单同步防护测试，锁定双源同步、幂等、同步日志、afterCommit 事件。
...
订单域审查报告、OrderSyncServiceTest.java、OrderSyncPersistenceServiceTest.java、RealDouyinOrderGatewayTest.java。
...
- plans/ddd-refactor/tasks/ddd-test-order-sync-001.md
