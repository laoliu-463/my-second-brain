---
kb_id: "KB-PLAN-DDD-DDD-FACADE-USER-001"
title: "DDD-FACADE-USER-001"
domain: "user"
category: "task_card"
source_type: "mixed"
freshness: "current"
...
新增极薄 UserDomainFacade，先迁移 1-3 个明确跨域用户查询点，业务行为不变。
...
用户域计划、用户域审查报告、SysUserService.java、CurrentUserController.java、跨域用户查询调用点。
...
- plans/ddd-refactor/tasks/ddd-facade-user-001.md
- plans/ddd-refactor/domains/user-ddd-plan.md
