---
kb_id: "KB-PLAN-DDD-DDD-TEST-SAMPLE-LIFECYCLE-001"
title: "DDD-TEST-SAMPLE-LIFECYCLE-001"
domain: "sample"
category: "task_card"
source_type: "mixed"
freshness: "current"
...
只新增或增强寄样生命周期防护测试，锁定状态流转、非法流转、订单事件完成条件。
...
寄样域审查报告、SampleLifecycleServiceTest.java、SampleControllerTest.java。
...
- plans/ddd-refactor/tasks/ddd-test-sample-lifecycle-001.md
