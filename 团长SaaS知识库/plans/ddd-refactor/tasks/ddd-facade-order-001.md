---
kb_id: "KB-PLAN-DDD-DDD-FACADE-ORDER-001"
title: "DDD-FACADE-ORDER-001"
domain: "order"
category: "task_card"
source_type: "mixed"
freshness: "current"
...
新增 OrderDomainFacade，对外暴露订单事实只读/事件接口，避免其他域直接穿透订单 Mapper。
...
订单域计划、订单域审查报告、OrderQueryService.java、OrderService.java、订单 Mapper 调用点。
...
- plans/ddd-refactor/tasks/ddd-facade-order-001.md
